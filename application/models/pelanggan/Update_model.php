...
class Update_model extends CI_Model
{
    ...
    function kirim_bukti_paket_dp_ulang()
    {
        $config['upload_path']   = './assets/bukti_tranfer';
        $config['allowed_types'] = 'jpeg|jpg|png|gif';
        $config['encrypt_name']  = true;
    ...
    function batal_proses()
    {
        $this->db->where('no_pesanan', $this->input->post('no_pesanan'));
        $this->db->delete('pesanan_paket');
        $this->session->set_flashdata('pesan_berhasil', '<div class="alert alert-success" id="pesan_berhasil" role="alert">Batal Pemesanan Paket Liburan!</div>');
    }
    function kirim_ulang_proses()
    {
        $data = array(
            'harga_paket'     => $this->input->post('penawaran_baru'),
            'status_paket'    => 'PROSES'
        );
        $this->db->where('no_pesanan', $this->input->post('no_pesanan'));
        $this->db->update('pesanan_paket', $data);
        $this->session->set_flashdata('pesan_berhasil', '<div class="alert alert-success" id="pesan_berhasil" role="alert">Mengirim Penawaran Ulang Pemesanan Paket Liburan!</div>');
    }
    function kirim_bukti_paket_lunas()
    {
        $config['upload_path']   = './assets/bukti_tranfer';
        $config['allowed_types'] = 'jpeg|jpg|png|gif';
        $config['encrypt_name']  = true;
    ...
    function kirim_bukti_paket_lunas_ulang()
    {
        $config['upload_path']   = './assets/bukti_tranfer';
        $config['allowed_types'] = 'jpeg|jpg|png|gif';
        $config['encrypt_name']  = true;
